/**
 * Logging functionality for radr-lib and any applications built on it.
 */
 ...
 * @example
 *
 *   var log = require('radr').log.sub('server');
 *
 ...
 *     radr.log.debug('My object is', myObj);
 */
module.exports = new Log();

/**
 * This is the logger for radr-lib internally.
 */
